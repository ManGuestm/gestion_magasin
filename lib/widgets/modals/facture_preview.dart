...
class FacturePreview extends StatelessWidget {
  ...
  Future<pw.Document> _generatePdf() async {
    ...
    final int totalPages = (lignesVente.length / maxLinesPerPage).ceil();

    for (int pageIndex = 0; pageIndex < totalPages; pageIndex++) {
      final int startIndex = pageIndex * maxLinesPerPage;
      final int endIndex = (startIndex + maxLinesPerPage).clamp(0, lignesVente.length);
      final List<Map<String, dynamic>> pageLines = lignesVente.sublist(startIndex, endIndex);
                    ...
                    children: [
                      ...
                      pw.Column(
                        ...
                        children: [
                          ...
                          pw.Text('Client: $client', style: pw.TextStyle(fontSize: pdfFontSize)),
                          pw.Text('SELLY', style: pw.TextStyle(fontSize: pdfFontSize)),
                          if (totalPages > 1)
                        ...
                        pw.Column(
                          ...
                          children: [
                            ...
                            if (remise > 0)
                              pw.Row(
                                children: [
                                  pw.Text('Remise', style: pw.TextStyle(fontSize: pdfFontSize)),
                                  pw.SizedBox(width: format == 'A6' ? 8 : 15),
                                  pw.Text(_formatNumber(totalHT * remise / 100),
                                      style: pw.TextStyle(fontSize: pdfFontSize)),
                                ],
                              ),
                            pw.Row(
                              children: [
                                ...
                                pw.SizedBox(width: format == 'A6' ? 8 : 15),
                                pw.Text(_formatNumber((totalHT - (totalHT * remise / 100)) * tva / 100),
                                    style: pw.TextStyle(fontSize: pdfFontSize)),
                              ],
                            ),
                            pw.Container(
                            ...
                            pw.SizedBox(height: format == 'A6' ? 3 : 6),
                            pw.Row(
                              children: [
                                pw.Text('Montant reçu', style: pw.TextStyle(fontSize: pdfFontSize)),
                                pw.SizedBox(width: format == 'A6' ? 8 : 15),
                                pw.Text(_formatNumber(montantRecu),
                                    style: pw.TextStyle(fontSize: pdfFontSize)),
                              ],
                            ),
                            pw.Row(
                              children: [
                                pw.Text('Monnaie à rendre', style: pw.TextStyle(fontSize: pdfFontSize)),
                                pw.SizedBox(width: format == 'A6' ? 8 : 15),
                                pw.Text(_formatNumber(monnaieARendre),
                                    style: pw.TextStyle(fontSize: pdfFontSize)),
                              ],
                            ),
                          ],
                    ...
                    pw.Column(
                      ...
                      children: [
                        pw.Text('Mode de paiement:',
                            style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: pdfFontSize)),
                        pw.Text(modePaiement, style: pw.TextStyle(fontSize: pdfFontSize)),
                      ],
                    ),
              ...
              child: Center(
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Container(
                      padding: EdgeInsets.all(format == 'A6'
                          ? 8
                          : format == 'A5'
                              ? 12
                              : 16),
                        ...
                        children: [
                            ...
                            children: [
                                  ...
                                  children: [
                                    if (societe?.rsoc != null)
                                      Text(
                                        societe!.rsoc!,
                                        style:
                                            TextStyle(fontWeight: FontWeight.bold, fontSize: _headerFontSize),
                                      ),
                                    if (societe?.activites != null)
                                      Text(
                                        societe!.activites!,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text('Doit: $client', style: TextStyle(fontSize: _fontSize)),
                                ],
                              ),
                            ],
                          ),
                          ...
                          Table(
                            ...
                            children: [
                              ...
                              // Data rows
                              ...lignesVente.map((ligne) => TableRow(
                                    children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if (remise > 0)
                                    Row(
                                      children: [
                                        Text('Remise', style: TextStyle(fontSize: _fontSize)),
                                        SizedBox(width: format == 'A6' ? 10 : 20),
                                        Text(_formatNumber(totalHT * remise / 100),
                                            style: TextStyle(fontSize: _fontSize)),
                                      ],
                                    ),
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: format == 'A6' ? 10 : 20),
                                      Text(_formatNumber((totalHT - (totalHT * remise / 100)) * tva / 100),
                                          style: TextStyle(fontSize: _fontSize)),
                                    ],
                                  ),
                                  Container(
                                  ...
                                  Row(
                                    children: [
                                      Text('Montant reçu', style: TextStyle(fontSize: _fontSize)),
                                      SizedBox(width: format == 'A6' ? 10 : 20),
                                      Text(_formatNumber(montantRecu), style: TextStyle(fontSize: _fontSize)),
                                    ],
                                  ),
                                  Row(
                                    children: [
                                      Text('Monnaie à rendre', style: TextStyle(fontSize: _fontSize)),
                                      SizedBox(width: format == 'A6' ? 10 : 20),
                                      Text(_formatNumber(monnaieARendre),
                                          style: TextStyle(fontSize: _fontSize)),
                                    ],
                                  ),
                                ],
                          ...
                          Column(
                            ...
                            children: [
                              Text('Mode de paiement:',
                                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: _fontSize)),
                              Text(modePaiement, style: TextStyle(fontSize: _fontSize)),
                            ],
                          ),
