...
class _MiseAJourValeursStocksModalState extends State<MiseAJourValeursStocksModal> {
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: const Row(
                              children: [
                                Expanded(flex: 3, child: Center(child: Text('Article', style: TextStyle(fontWeight: FontWeight.bold)))),
                                ...
                                Expanded(child: Center(child: Text('Valeur', style: TextStyle(fontWeight: FontWeight.bold)))),
                              ],
                            ),
                          ),
                          Expanded(
