...
class BonLivraisonPreview extends StatelessWidget {
                    ...
                    pw.Column(
                      ...
                      children: [
                        pw.Text('Mode de paiement:',
                            style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: pdfFontSize)),
                        pw.Text('A crédit', style: pw.TextStyle(fontSize: pdfFontSize)),
                      ],
                    ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  'Aperçu BL N° $numVente - Format $format',
