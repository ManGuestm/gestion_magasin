...
class _OperationsCaissesModalState extends State<OperationsCaissesModal> with TabNavigationMixin {
    ...
    try {
      ...
      switch (_selectedPeriod) {
        ...
        case 'Cette semaine':
          ...
          filteredOperations =
              allCaisses.where((c) => c.daty != null && c.daty!.isAfter(startOfWeek)).toList();
          break;
        case 'Ce mois':
          filteredOperations = allCaisses
              .where((c) => c.daty != null && c.daty!.year == now.year && c.daty!.month == now.month)
              .toList();
          break;
        default:
          filteredOperations = allCaisses;
