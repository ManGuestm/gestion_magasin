...
class _StatistiquesVentesModalState extends State<StatistiquesVentesModal> {
  ...
  Future<void> _loadVentes() async {
    try {
      ...
      switch (_selectedPeriod) {
        case 'Aujourd\'hui':
          filteredVentes = allVentes.where((v) => 
            v.daty != null && 
        ...
        case 'Cette semaine':
          ...
          filteredVentes = allVentes.where((v) => 
            v.daty != null && v.daty!.isAfter(startOfWeek)
          ).toList();
          break;
        case 'Ce mois':
          filteredVentes = allVentes.where((v) => 
                          ...
                          Container(
                            ...
                            child: const Row(
                              children: [
                                ...
                                Expanded(child: Center(child: Text('Total HT', style: TextStyle(fontWeight: FontWeight.bold)))),
                                Expanded(child: Center(child: Text('TVA', style: TextStyle(fontWeight: FontWeight.bold)))),
