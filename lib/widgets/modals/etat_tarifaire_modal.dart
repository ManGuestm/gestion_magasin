...
class _EtatTarifaireModalState extends State<EtatTarifaireModal> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Icon(Icons.price_check, color: Colors.white, size: 14),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildHeaderCell('MARGE U1', 80),
          _buildHeaderCell('MARGE U2', 80),
          _buildHeaderCell('MARGE U3', 80),
  ...
  Widget _buildTableRow(Article article, int index) {
    ...
    final margeU1 = (article.pvu1 ?? 0) - cmup;
    final margeU2 = (article.pvu2 ?? 0) - cmup;
    final margeU3 = (article.pvu3 ?? 0) - cmup;
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _buildCell(_formatNumber(cmup), 80, alignment: Alignment.centerRight),
          ...
          _buildCell(_formatNumber(margeU1), 80, alignment: Alignment.centerRight),
          _buildCell(_formatNumber(margeU2), 80, alignment: Alignment.centerRight),
          _buildCell(_formatNumber(margeU3), 80, alignment: Alignment.centerRight),
