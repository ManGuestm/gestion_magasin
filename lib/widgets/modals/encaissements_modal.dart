      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Revenu ajouté avec succès')));
        }
      } catch (e) {
        if (mounted) {
          ScaffoldMessenger.of(
    ...
    if (result != null) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Revenu modifié avec succès')));
        }
      } catch (e) {
        if (mounted) {
          ScaffoldMessenger.of(
    ...
    if (confirm == true) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(const SnackBar(content: Text('Revenu supprimé avec succès')));
        }
      } catch (e) {
        if (mounted) {
          ScaffoldMessenger.of(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(labelText: 'Catégories', border: OutlineInputBorder()),
